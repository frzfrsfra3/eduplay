    ...
    public function setuserprofile ()
    {
        ...
        try {
            ...
            if ($user) {
                ...
                {
                    if(file_exists(public_path('Images/'.$user['user_image']))) {
                        unlink(public_path('Images/'.$user['user_image']));
                    }
                    $user['user_image'] = time() . "_" . $file->getClientOriginalName();
                    $destinationPath = public_path('Images/');
                    $file->move($destinationPath, $user['user_image']);
                }
                else{
