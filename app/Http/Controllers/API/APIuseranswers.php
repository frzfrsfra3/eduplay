        ...
        try {
            ...
            if ($user) {
                ...
                if ($useranswer) {
                    ...
                    $val= $this->setskillmasterylevels_for_game($user->id,$data['question_id'] );
                 ...
                 else
                {
                   ...
                   $count_saved=0;
                    ...
                    foreach($useranswers as $answer) {
                        if (!array_key_exists('params', $answer)){$answer['params']=0;}
                        ...
                        if ($validator->fails ()) {
                            ...
                            $useranswer=Userexamanswer::where('user_id','=' ,$user->id)->where('gameid','=', $answer_data['gameid'])
                                ...
                                ->where('params','=' , $answer_data['params'])
