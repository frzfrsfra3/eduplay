...
class GamerestrictedkidsController extends Controller {
    ...
    public function store(Request $request) {
        try {
            ...
            return redirect()->route('gamerestrictedkids.gamerestrictedkid.index')->with('success_message', 'Gamerestrictedkid was successfully added!');
        }
    ...
    public function update($id, Request $request) {
        try {
            ...
            return redirect()->route('gamerestrictedkids.gamerestrictedkid.index')->with('success_message', 'Gamerestrictedkid was successfully updated!');
        }
        catch(Exception $exception) {
            return back()->withInput()->withErrors(['unexpected_error' => 'Unexpected error occurred while trying to process your request!']);
        }
    ...
    public function destroy($id) {
        try {
            ...
            return redirect()->route('gamerestrictedkids.gamerestrictedkid.index')->with('success_message', 'Gamerestrictedkid was successfully deleted!');
        }
        catch(Exception $exception) {
            return back()->withInput()->withErrors(['unexpected_error' => 'Unexpected error occurred while trying to process your request!']);
        }
    ...
    protected function getData(Request $request) {
        $rules = ['kid_id' => 'required', 'game_id' => 'required', 'restricted_by' => 'required', 'isactive' => 'required', ];
