    ...
    public function getuserbadges ()
    {
        ...
        if ($user) {
            ...
            if ($user_badge) {
                ...
                $deaultbage=array();
                $deaultbage['user_id']=$user->id;
                $deaultbage['badge_id'] = 0;
                $deaultbage['badgetitle'] ='Default Badges';
                $deaultbage['badgedescription'] ='Default Badges';
                $deaultbage['badgeimageurl']=$imagesurl . "/default_badges.png" ;
                $deaultbage['badgeorder'] = 1;
                $deaultbage['badge_condition'] = 'Default Badges';
                $deaultbage=array($deaultbage);
                $responce = $this->renderresponse ($deaultbage,'This user have default badges');
