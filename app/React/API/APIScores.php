...
class APIScores extends Controller
{
    ...
    public function getscore(){
        ...
        try {
            ...
            if ($topic->count() > 0) {
             ...
             //
              //
           //     $highscores =  $highscores->distinct()->take(20)->get();
            ...
            if ($highscores->count() <> 0) {
                ...
                foreach ($highscores as $singlescore) {
                    ...
                    if ($singlescore->remember_token == $remember_token && empty($userscore)) {
                        ...
                        $userscore['score'] = $this->getuserscore($singlescore->user_id,'score');
                        $userscore['rank'] = $i+1;
    ...
    function getuserscore($id,$ord) {
        ...
        $score=Userexamscore::where ("user_id",'=',$id)->orderBy('score', 'desc')->take(1)->get();
