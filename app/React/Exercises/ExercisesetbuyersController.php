...
$users = User::pluck('id','id')->all();
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('exercisesetbuyers.exercisesetbuyer.index')
                             ->with('success_message', 'Exercisesetbuyer was successfully added!');
...
$users = User::pluck('id','id')->all();
    ...
    public function update($id, Request $request)
    {
        try {
            ...
            return redirect()->route('exercisesetbuyers.exercisesetbuyer.index')
                             ->with('success_message', 'Exercisesetbuyer was successfully updated!');
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('exercisesetbuyers.exercisesetbuyer.index')
                             ->with('success_message', 'Exercisesetbuyer was successfully deleted!');
    ...
    */
    ...
    {
        $rules = [
            'exerciseset_id' => 'required',
            'user_id' => 'required',
            'joindate' => 'required|date_format:j/n/Y g:i A',
