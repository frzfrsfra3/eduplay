...
class GamedetailsController extends Controller
{
    ...
    public function store (Request $request)
    {
        try {
            ...
            return redirect ()->route ('gamedetails.gamedetail.index')
                ->with ('success_message', 'Gamedetail was successfully added!');
    ...
    public function update ($id, Request $request)
    {
        try {
            ...
            return redirect ()->route ('gamedetails.gamedetail.index')
                ->with ('success_message', 'Gamedetail was successfully updated!');
    ...
    public function destroy ($id)
    {
        try {
            ...
            return redirect ()->route ('gamedetails.gamedetail.index')
                ->with ('success_message', 'Gamedetail was successfully deleted!');
    ...
    protected function getData (Request $request)
    {
        $rules = [
            ...
            'game_id' => 'required',
            'android_link' => 'nullable|string|min:0|max:500',
            'ios_link' => 'nullable|string|min:0|max:500',
            'ios_bundle_id' => 'nullable',
            'ios_url_scheme_suffix' => 'nullable|string|min:0|max:500',
            'ios_iphone_store_id' => 'nullable',
            'ios_ipad_store_id' => 'nullable',
            'android_package_name' => 'nullable|numeric|string|min:0|max:500',
            'android_key_hashes' => 'nullable|string|min:0|max:500',
            'android_class_name' => 'nullable|string|min:0|max:500',
            'android_amazon_url' => 'nullable|string|min:0|max:500',
