...
class NotificationsactionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('notificationsactions.notificationsaction.index')
                             ->with('success_message', 'Notificationsaction was successfully added!');
    ...
    public function update($id, Request $request)
    {
        try {
            ...
            return redirect()->route('notificationsactions.notificationsaction.index')
                             ->with('success_message', 'Notificationsaction was successfully updated!');
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('notificationsactions.notificationsaction.index')
                             ->with('success_message', 'Notificationsaction was successfully deleted!');
    ...
    {
        $rules = [
            'modelname' => 'required|string|min:1|max:250',
            'notificationtpl' => 'required',
            'type' => 'required',
