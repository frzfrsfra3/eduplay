...
$skills = Skill::pluck('id','id')->all();
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('userskillmasterylevels.userskillmasterylevel.index')
                             ->with('success_message', 'User Skillmasterylevel was successfully added!');
...
$skills = Skill::pluck('id','id')->all();
    ...
    public function update($id, Request $request)
    {
        try {
            ...
            return redirect()->route('userskillmasterylevels.userskillmasterylevel.index')
                             ->with('success_message', 'User Skillmasterylevel was successfully updated!');
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('userskillmasterylevels.userskillmasterylevel.index')
                             ->with('success_message', ' User Skillmasterylevel was successfully deleted!');
    ...
    protected function getData(Request $request)
    {
        $rules = [
            ...
            'masteryLevel' => 'required|numeric|min:-2147483648|max:2147483647',
