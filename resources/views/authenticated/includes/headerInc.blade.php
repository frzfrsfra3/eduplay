...
<link rel="stylesheet" href="{{ asset('assets/eduplaycloud/css/jquery.CalendarHeatmap.css') }}" type="text/css" media="all">
<link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/css/select2.min.css" rel="stylesheet" />
@if ($lang == 'ar')
<link rel="stylesheet" href="{{ asset('assets/eduplaycloud/css/rtl.css') }}" media="all" type="text/css">
@endif
<link rel="stylesheet" href="{{ asset('assets/eduplaycloud/customs/css/introjs.css') }}"/>
