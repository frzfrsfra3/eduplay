...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Classexercises</h4>
            </div>
        ...
        @if(count($classexercises) == 0)
            <div class="panel-body text-center">
                <h4>No Classexercises Available!</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($classexercises as $classexercise)
                        <tr>
                            <td>{{ optional($classexercise->courseclass)->id }}</td>
                            <td>{{ optional($classexercise->exercise)->id }}</td>
                            <td>{{ $classexercise->addedon }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('classexercises.classexercise.show', $classexercise->id ) }}" class="btn btn-info" title="Show Classexercise">
