<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header ">
            ...
            <h4 id="gridSystemModalLabel" class="modal-title">Create New Skill</h4>
        </div>
        <div class="panel-body">
            ...
            <form method="POST" accept-charset="UTF-8" id="create_skill_form" name="create_skill_form"   action="{!! route('skills.skill.store') !!}"  class="form-horizontal">
                {{ csrf_field() }}
                <input class="form-control" name="id_from" type="hidden" id="id_from" value="" minlength="1"
                       maxlength="200" required="true">
                @include ('collaboration.form_skill_collaboration', [
                                            'skill' => null,
