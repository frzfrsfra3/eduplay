...
<div class="col-md-6 col-lg-6 col-xl-3 cusmize-col">
    <div class="main_info pstn_rltv">
        ...
        @if(Auth::user()->id == $googleclass->user_id)
            <button class="btn delet_request" onclick="add_remove_exercise_to_class( '{{ route('classroom.exercise.removeexercise', [$googleclass->id  ,$myexercise->id ] ) }}','{!! $myexercise->id !!}' ,'remove') "></button>
        @endif
        <ul class="title_cmbo">
