...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('curricula.curriculum.update', $curriculum->id) }}" id="edit_curriculum_form" name="edit_curriculum_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
