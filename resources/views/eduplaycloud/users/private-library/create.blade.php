    ...
    <div class="row justify-content-center">
        <div class="col-lg-11">
            <div class="inner_add_child text-ar-right">
                <h6>@lang('exerciseset_form.create_new_exercise')</h6>
                <form method="POST" action="{{ route('exercisesets.exerciseset.store') }}" id="edit_exerciseset_form" name="edit_exerciseset_form" accept-charset="UTF-8" class="def_form full_def_frm" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    <div class="row">
