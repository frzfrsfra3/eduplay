                ...
                <div class="simple_ed_cls mrgn-tp-10 mrgn-bt-5">
                        ...
                        <div class="tab-pane fade show active" id="summary" role="tabpanel" aria-labelledby="summary-tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-sm-right text-ar-left">
                                    @if(Auth::user()->id == $exerciseset->createdby)
                                        <a href="javascript:;" id="code_gn_btn" class="conver_to_problem">@lang('exerciseset_show.game_code_generate')</a>
                                        ...
                                        <div class="discription_block gray_bg_blk">
                                            ...
                                            <table>
                                              ...
                                              @if(count($associatedSkills) > 0)
                                                  @foreach($associatedSkills as $skill)
                                                    <tr>
                    ...
                    <!--End Filter Section-->
                        ...
                        <input type="hidden" id="exercise_id" value="{{$exerciseset->id}}">
                                                ...
                                                <div class="panel-title">
                                                    <div class="quesn_abl_ckbx">
                                                        <div class="checkbox-sml custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label" for="Learner"></label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="right_btn_secn">
                                                        <a href="#" class="gray_edit_btn"></a>
                                                        <a href="#" class="gray_delete_btn"></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="collapseOne" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="headingOne">
                                                <div class="panel-body">
                                                    <ul class="ans_list optn_list">
                                                        @{{#Answers.Choices}}
                                                            @{{#Attributes}}
                                                                @{{#IsCorrect}}
                                ...
                                {{-- <div class="col-md-12" id="question_list_preview">
                        ...
                        <div class="tab-pane fade simple_editor" id="simple_editor" role="tabpanel" aria-labelledby="simple_editor-tab">
                            @include('eduplaycloud.users.private-library.simple_editor')
                        </div>
                        <div class="tab-pane fade simple_editor" id="edit_simple_editor" role="tabpanel" aria-labelledby="edit_simple_editor-tab">
                            <div id="edit_que_div">
...
<!--Game code generate form-->
<form method="POST" action="{{route('games.generate.code')}}" id="genrate_code_from">
  @csrf
  <input type="hidden" name="exercise_id" value="{{$exerciseset->id}}">
  <input type="hidden" name="topic_id" value="{{$exerciseset->topic_id}}">
  <input type="hidden" name="discipline_id" value="{{$exerciseset->discipline_id}}">
  <input type="hidden" name="grade_id" value="{{$exerciseset->grade_id}}">
</form>
<!-- Plugins List Modal -->
...
<!-- pugin static Modal -->
<div class="modal fade default_modal wht_bg_mdl plgn_asts" id="plugin_list_id" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
...
//-----Game code generate function------

$(document).on('click','#code_gn_btn',function(){

       swal({
          title: '@lang("exerciseset_show.game_code")' ,
          text: "@lang('exerciseset_show.sure_generate')",
          icon: "warning",
          buttons: [
