                                ...
                                <div class="step-content">
                                    ...
                                    <div class="step-tab-panel" id="tab3">
                                        ...
                                        <form class="categories_form">
                                            <div class="row">
                                            <div class="col-11-rduce col-md-6 col-lg-6 col-xl-3 mrgn-bt-20">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group mrgn-bt-30">
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        <div class="form-group mrgn-bt-30">
                                                        <div class="checkbox-sml custom-control custom-checkbox">
                                                            <input name="selectedId"  value="1" id="numbers" type="checkbox" class="custom-control-input selectedId">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="form-group mrgn-bt-30">
                                                        <label class="questn_lbl">Max Questions :</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        <div class="form-group mrgn-bt-30">
                                                        <div class="checkbox-sml custom-control custom-checkbox">
                                                            <input name="selectedId"  value="1" id="Probability" type="checkbox" class="custom-control-input selectedId">
                                                            <label class="custom-control-label" for="Probability">Probability</label>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        <div class="form-group mrgn-bt-30">
                                                        <div class="checkbox-sml custom-control custom-checkbox">
                                                            <input name="selectedId"  value="1" id="Time" type="checkbox" class="custom-control-input selectedId">
