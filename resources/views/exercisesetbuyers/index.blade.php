...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Exercisesetbuyers</h4>
            </div>
        ...
        @if(count($exercisesetbuyers) == 0)
            <div class="panel-body text-center">
                <h4>No Exercisesetbuyers Available!</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($exercisesetbuyers as $exercisesetbuyer)
                        <tr>
                            <td>{{ optional($exercisesetbuyer->exerciseset)->id }}</td>
                            <td>{{ optional($exercisesetbuyer->user)->id }}</td>
                            <td>{{ $exercisesetbuyer->joindate }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('exercisesetbuyers.exercisesetbuyer.show', $exercisesetbuyer->id ) }}" class="btn btn-info" title="Show Exercisesetbuyer">
