...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Gamedownloads</h4>
            </div>
        ...
        @if(count($gamedownloads) == 0)
            <div class="panel-body text-center">
                <h4>No Gamedownloads Available!</h4>
            </div>
        @else
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    @foreach($gamedownloads as $gamedownload)
                        <tr>
                            <td>{{ optional($gamedownload->user)->id }}</td>
                            <td>{{ optional($gamedownload->game)->id }}</td>
                            <td>{{ $gamedownload->download_type }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('gamedownloads.gamedownload.show', $gamedownload->id ) }}" class="btn btn-info" title="Show Gamedownload">
