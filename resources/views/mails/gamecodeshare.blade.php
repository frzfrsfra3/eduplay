			...
			<tbody>
				...
				<tr>
					<td style="text-align: left;">
                        <h3 style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #212121;margin: 0 0 10px 0;font-weight: bold;">Game Preference Code</h3>
                        <br/>
                        <p style="font-family: 'Open Sans', sans-serif; font-size: 13px; color: #212121;margin: 0 0 10px 0;">Your teacher <b>{{$user->name}}</b> shares the game preference code with you..</p>
                        <br/>
                        <p  style="font-family: 'Open Sans', sans-serif; font-size: 13px; color: #212121;margin: 0 0 10px 0;">Please use this code for the game : <b>{{ $code  }}</b>
