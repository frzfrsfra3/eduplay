...
<table border="0" cellpadding="0" cellspacing="0" style="width: 770px;">
    ...
    <tr>
        <td style="text-align: left;">
            <h3 style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #212121;margin: 0 0 10px 0;font-weight: bold;">Hello {{ $receiverName }}</h3>
            <p style="font-family: 'Open Sans', sans-serif; font-size: 13px; color: #212121;margin: 0 0 10px 0;">
                {{ Auth::user()->name }} has invited you to his/her courseclass. <a href="{{ $class_url }}"> Click here </a> to show it.
            </p>
        </td>
    </tr>
    <!--End Content-->
