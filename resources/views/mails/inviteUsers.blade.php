			...
			<tbody>
				...
				<tr>
					<td style="text-align: left;">
                        <h3>Hello User,</h3>
                        <p style="font-family: 'Open Sans', sans-serif; font-size: 13px; color: #212121;margin: 0 0 10px 0;">Your Friend <b>{{ $user }}</b> invites you in Eduplaycloud.</p>
                    <br>
                    <p style="display: block;text-align: center;">
                    <a href="{{ route('welcome') }}" style="font-family: 'Open Sans', sans-serif;font-size: 15px;color: #fff;border-radius: 5px;background-color: #3498db;padding: 8px 24px;text-decoration: none;display: inline-block;margin-bottom: 15px;">Visit Eduplaycloud</a></p>
					</td>
				</tr>
				<!--End Content-->
				<!--Start Footer-->
