	...
	<body>
		...
		<table border="0" cellpadding="0" cellspacing="0" style="width: 770px;">
          ...
          <td style="padding: 0;" bgcolor="#ff9028">
              ...
              <p style="font-family: 'Open Sans', sans-serif; font-size: 13px; color: #212121;margin: 0 0 10px 0;">Here's look at what you achieved this week, Check it out and keep learning. </p>
              <br>
              <p style="display: block;text-align: center;">

         
              <a href="{{ $url }}" style="font-family: 'Open Sans', sans-serif;font-size: 15px;color: #fff;border-radius: 5px;background-color: #3498db;padding: 8px 24px;text-decoration: none;display: inline-block;margin-bottom: 15px;">+ {{$user->totalpoints}}</a></p>
					</td>
				</tr>
				<!--End Content-->
				<!--Start Footer-->
