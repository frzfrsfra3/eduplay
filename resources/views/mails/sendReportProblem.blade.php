...
<table border="0" cellpadding="0" cellspacing="0" style="width: 770px;">
    ...
    <tr>
        <td style="text-align: left;">
            <p><b>Hello  {{$question->exercise->owner->name}},</b></p>
            {{--  <br>  --}}
            <p><b>{{Auth::user()->name}}</b> has genarate report on the following details:</p>
            <br>
            <p><b>Question:</b> {{ $question->details }}</p>
            <br>
            <p><b>Student Description: </b></p>
            @if ($problem == 1)
                <p>The answer is wrong.</p>
            @elseif ($problem == 2)
                <p>I caught a typo.</p>
            @elseif ($problem == 3)
                <p>The question or hints are confusing or unclear.</p>
            @else
                <p>Something isn’t working / something seems broken.</p>
            @endif
            <br>
            <p><b>Student Feedback: </b></p>
            <p>{{ $description }}</p>
            <br>
            <p>To update the question,please click on this link after login. <a href="{{ url('/questions/edit_question',$question->id) }}" >Edit</a></p>
        </td>
    </tr>
    <!--End Content-->
