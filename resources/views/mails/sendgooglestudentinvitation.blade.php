...
<table border="0" cellpadding="0" cellspacing="0" style="width: 770px;">
    ...
    <tr>
        <td style="text-align: left;">
            <h3 style="font-family: 'Open Sans', sans-serif; font-size: 16px; color: #212121;margin: 0 0 10px 0;font-weight: bold;">Hello <b> {{ $child->name }} </b> </h3>
            <p style="font-family: 'Open Sans', sans-serif; font-size: 13px; color: #212121;margin: 0 0 10px 0;">The teacher registered with named  <b> {{ $sender->name }} </b> in Eduplaycloud has added you as a child in his/her profile. <br>
                    You can login with this Email:  {{ $child->email }}  and Password : {{ $rendompassword }}
                <br><br>
                And also you can visit Eduplaycloud in google class with this link <a href="{{$classURL}}">Click here</a>
                <br/>
                Thanks
                </p>
        </td>
