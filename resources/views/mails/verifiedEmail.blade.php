			...
			<tbody>
				...
				<tr>
					<td style="text-align: left;">
                        ...
                        <p style="font-family: 'Open Sans', sans-serif; font-size: 13px; color: #212121;margin: 0 0 10px 0;">Please click on given button for activate your account for login into the Eduplaycloud.</p>
                    <br>
                    <p style="display: block;text-align: center;">
                    <a href="{{ route('verifyAccount',['email'=>$user->email,'token'=>$token]) }}" style="font-family: 'Open Sans', sans-serif;font-size: 15px;color: #fff;border-radius: 5px;background-color: #3498db;padding: 8px 24px;text-decoration: none;display: inline-block;margin-bottom: 15px;">Activate Your Account</a></p>
					</td>
				</tr>
				<!--End Content-->
				<!--Start Footer-->
