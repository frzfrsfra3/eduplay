...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Notificationsactions</h4>
            </div>
        ...
        @if(count($notificationsactions) == 0)
            <div class="panel-body text-center">
                <h4>No Notificationsactions Available!</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($notificationsactions as $notificationsaction)
                        <tr>
                            <td>{{ $notificationsaction->modelname }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('notificationsactions.notificationsaction.show', $notificationsaction->id ) }}" class="btn btn-info" title="Show Notificationsaction">
