...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Usernotifications</h4>
            </div>
        ...
        @if(count($usernotifications) == 0)
            <div class="panel-body text-center">
                <h4>No Usernotifications Available!</h4>
            </div>
        @else
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    @foreach($usernotifications as $usernotification)
                        <tr>
                            <td>{{ $usernotification->receiver_userid }}</td>
                            <td>{{ $usernotification->sender_userid }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('usernotifications.usernotification.show', $usernotification->id ) }}" class="btn btn-info" title="Show Usernotification">
