                            ...
                            <td class="text-center">
                                ...
                                {{ csrf_field() }}
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('users.user.editrole', $user->id ) }}" class="btn btn-primary" title="Edit Role">
                                            <span class="glyphicon glyphicon-tent" aria-hidden="true"></span>
                                        </a>

                                        <a href="{{ route('useractivitylogs.useractivitylog.index', $user->id) }}" class="btn btn-warning" title="Show User Activiylogs">
                                ...
                                <a href="{{ route('subscriptions.index', $user->id ) }}" class="manage-subsciptions-btn btn btn-link" title="Edit User">
